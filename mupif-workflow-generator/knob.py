...
#         text_size = getTextSize(self.displayName, painter=painter)
...
#           flexible approach.
#         """
#         print("trying to connect two knobs (knob)")
#         # if event.button() == QtCore.Qt.LeftButton:
#         #
...
#         """
#         no_limits = self.maxConnections < 0 and knob.maxConnections < 0
#         if no_limits:
#             return
#
#         num_source_connections = len(self.edges)  # Edge already added.
#         num_target_connections = len(knob.edges) + 1
#
#         print(num_source_connections, num_target_connections)
#
#         source_max_reached = num_source_connections > self.maxConnections
#         target_max_reached = num_target_connections > knob.maxConnections
#
...
#         actual_target = edge.source
#         edge.source = edge.target
#         edge.target = actual_target
#     else:
